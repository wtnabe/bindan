...
require_relative "lib/bindan/version"

Gem::Specification.new do |spec|
  spec.name = "bindan"
  spec.version = Bindan::VERSION
  spec.authors = ["wtnabe"]
  spec.email = ["18510+wtnabe@users.noreply.github.com"]

  spec.summary = "Bindan is a Ruby gem for building single configuration object from various sources with providers."
  ...
  spec.homepage = "https://github.com/wtnabe/bindan"
  spec.required_ruby_version = ">= 3.0.0"

  spec.metadata["allowed_push_host"] = "https://rubygems.org"

  spec.metadata["homepage_uri"] = spec.homepage
  spec.metadata["source_code_uri"] = "https://github.com/wtnabe/bindan"
  spec.metadata["changelog_uri"] = "https://github.com/wtnabe/bindan/blob/main/CHANGELOG.md"
